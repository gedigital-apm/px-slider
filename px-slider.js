...
import 'px-number-formatter/px-number-formatter-behavior.js';
import 'px-number-formatter/px-number-formatter-no-display.js';
import 'px-component-helpers/px-common-behaviors.js';
import '@polymer/iron-a11y-keys/iron-a11y-keys.js';
import './css/px-slider-styles.js';
import './css/px-handle-styles.js';
...
`,
  ...
  _createTrackListeners() {
    var _this = this,
        interactionRects = Px.d3.selectAll(dom(this.$$('#sliderSVG')).querySelectorAll('.sliderTrack'));
  ...
  _removeTrackListeners() {
    var interactionRects = Px.d3.selectAll(dom(this.$$('#sliderSVG')).querySelectorAll('.sliderTrack'));
